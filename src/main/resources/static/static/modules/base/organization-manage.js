...
function initOrgMenuTree() {
    loading("正在加载...");
    $.ajax({
        url: CTX + 'organizationManage/query-org-tree',
        method: 'GET',
        dataType: 'json',
...
function initRoleMenuTree() {
    loading("正在加载...");
    $.ajax({
        url: CTX + 'organizationManage/query-role-tree',
        method: 'GET',
        dataType: 'json',
        success: function (json) {
...
function initOrgTreeContextmenu() {
    $('#orgMenuTree').contextmenu({
        ...
        before: function (e, context) {
            ...
            currentOrgNode = node;
            $('#addCompany,#addDept,#editCompany,#editDept,#downMenu,#upMenu,#removeMenu').show();
...
function initRoleTreeContextmenu() {
    $('#roleMenuTree').contextmenu({
        ...
        before: function (e, context) {
            ...
            $('#addCompany, #addDept, #editCompany, #editDept, #downMenu, #upMenu, #removeMenu').hide();
            $('#addRole, #editRole, #removeRole').show();
            //根据类型显示菜单
            if (currentRoleNode.nodeType == 'roleGroup') {
                $("#editRole").hide();
            }
        },
        onItem: function (context, e) {
...
function goEditUseunit(useunitId, parentId) {
    ...
    if (useunitId) {
        ...
        $.ajax({
            url: CTX + 'organizationManage/query-useunit-by-id',
            method: 'get',
            dataType: 'json',
...
function deleteUseunit() {
    ...
    $.ajax({
        url: CTX + 'organizationManage/delete-useunit-by-id',
        method: 'get',
        dataType: 'json',
        data: {useunitId:useunitId},
        success: function (json) {
...
function goAddSysuer() {
    //新增成员校验上限人数
    $.ajax({
        url: CTX + 'organizationManage/check-sysuser-num',
        type: 'get',
        dataType: '',
...
function goEditSysuser(sysuserId) {
    ...
    //用户选择部门下拉树
    $.ajax({
        url: CTX + 'organizationManage/query-org-tree', // 请求的URL
        dataType: 'json',
        type: "get",
        success: function (data) {
    ...
    if(null != sysuserId){
        ...
        $.ajax({
            url: CTX + 'organizationManage/query-sysuser-by-id',
            method: 'get',
            dataType: 'json',
...
function sysuserSelectRole() {
    ...
    $.ajax({
        url: CTX + 'organizationManage/query-sysuser-role-tree',
        method: 'GET',
        dataType: 'json',
        data: {sysuserId: sysuserId},
        success: function (json) {
...
function goEditRole(roleId) {
    ...
    if(null != roleId){
        ...
        $.ajax({
            url: CTX + 'organizationManage/query-role-by-id',
            method: 'get',
            dataType: 'json',
            data: {roleId: roleId},
            success: function (json) {
...
function roleSelectAuth() {
    ...
    $.ajax({
        url: CTX + 'organizationManage/query-auth-tree-by-sysuser',
        method: 'GET',
        dataType: 'json',
        success: function (json) {
...
function checkAuthSubNode(node) {
    ...
    if(node.nodes != null && node.nodes.length>0 ){
        for(var i = 0; i < node.nodes.length; i++){
            $('#authMenuTree').treeview('checkNode', [node, { silent: true}]);
...
function deleteRole() {
    ...
    $.ajax({
        url: CTX + 'organizationManage/delete-role-by-id',
        method: 'get',
        dataType: 'json',
        data: {roleId:roleId},
        success: function (json) {
...
function goEditRoleSysuser() {
    ...
    //初始化组织结构树
    $.ajax({
        url: CTX + 'organizationManage/query-user-sub-org-tree',
        method: 'GET',
        dataType: 'json',
        data: {sysuserId: sysuserId},
        success: function (json) {
    ...
    //加载角色下属所有成员信息
    $.ajax({
        url: CTX + 'organizationManage/query-sysuser-by-role',
        method: 'GET',
        dataType: 'json',
...
function goAllowSysuser(id, isValid) {
    $.ajax({
        url: CTX + 'organizationManage/allow-sysuser',
        method: 'GET',
        dataType: 'json',
